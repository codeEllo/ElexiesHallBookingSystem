  ...
  <div class="reg-input-field">
        ...
        <form action="CupClientprocess.php? cliId=<?php echo $cliId;?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nme" style="width:20em;" placeholder="Enter your Name" required />
          </div>
		   <br><br>
          <div class="form-group">
            <label>Phone Number</label>
            <input type="text" class="form-control" name="phNum" style="width:20em;" placeholder="Enter your Phone Number" required />
          </div>
		  <br><br>
          <div class="form-group">
            <label>Email Address</label>
            <input type="text" class="form-control" name="email" style="width:20em;"  placeholder="Enter your Email Address" required/>
          </div>
	       <br><br>
			<div>
            <label>New Password</label>
            <input type="Password" class="form-control" name="pass" style="width:20em;"  placeholder="Enter your New Password" required />
          </div>
	       <br><br>
          <div class="form-group">
