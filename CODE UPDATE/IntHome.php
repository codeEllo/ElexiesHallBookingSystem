        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="admin_login.php"><i class="fa fa-sign-out fa-fw"></i> Sign Out</a>
                    </li>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td>'.$row['CLIENT_ID'].'</td>
                                            <td>'.$row['HALL_ID'].'</td>
                                            <td><a href="UpdateBooking.php?BOOK_ID='.$row['BOOK_ID'].'" class="btn btn-warning"
                                            role="button">approve</a></td>
                                            <td><a href="UpdateBooking.php?BOOK_ID='.$row['BOOK_ID'].'" class="btn btn-danger"
                                            role="button">declined</a></td>';}
                                        ?>
