...
<br><br>
<h3 align="center" style="font-family: Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, 'serif';font-weight: bold;color:black;">MY BOOKING HISTORY</h3>
<br><br>
...
//$cliId = $_POST["Cli_ID"];
$sql = "SELECT * FROM `hall_booking` WHERE CLIENT_ID = '$id'";
