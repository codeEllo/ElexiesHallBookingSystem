...
?>
		...
		<div class="form-wrapper"> <!-- Form-wrapper only for positioning -->
			<form action="PHPHallDelete.php" method="post" class="fcorn-register container">
			<div class="row">	
				...
				<p><input type="text"  name="HALL_TYPE" placeholder="Enter Hall Type"  value='<?=$row['HALL_TYPE'];?>' readonly>
                ...
                <p class="col-md-6"><input type="number" name="HALL_PRICE" placeholder="Price" min="1"  value='<?=$row['HALL_PRICE'];?>' readonly></p>
                
                <p class="col-md-6"><input type="number" name="HALL_CAPACITY" placeholder="Capacity" min="1"  value='<?=$row['HALL_CAPACITY'];?>' readonly></p>
        	...
        	<p class="register-toggle">
				...
				<p class="register-submit"><input name="submit" type="submit" value="Delete" onClick="return confirm('Are you sure?')"></p>
			</form>
		</div>
