    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="Hall Booking.php">Hall Booking</a></li>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="img/Bronze.jpg" alt="Jane" style="width:100%">
      <div class="contain">
        <h2><strong>BRONZE<strong></h2>
		<p><strong><h3>HALL ID: B001 </h3></strong></p>			
				<table> 
			<tr>
				<th>Capacity</th>
  ...
  <div class="column">
    <div class="card">
      <img src="img/Silver.jpg" alt="Mike" style="width:100%">
      <div class="contain">
        <h2><strong>SILVER<strong></h2>
		<p><strong><h3>HALL ID: S001 </h3></strong></p>
		<table> 
			<tr>
				<th>Capacity</th>
				<td> &nbsp &nbsp  &nbsp  &nbsp  &nbsp  </td>
  ...
  <div class="column">
    <div class="card">
      <img src="img/Golden.jpg" alt="John" style="width:100%">
      <div class="contain">
        <h2><strong>GOLDEN<strong></h2>
		<p><strong><h3>HALL ID: G001 </h3></strong></p>
			<table> 
				<tr>
					<th>Capacity</th>
					<td> &nbsp &nbsp  &nbsp  &nbsp  &nbsp  </td>
