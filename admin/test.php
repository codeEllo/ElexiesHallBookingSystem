    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="IntHome.php">MAIN MENU </a>
            </div>
         ...
         <div class="card card-profile shadow">
           <div class="row justify-content-center">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <?php
                if(!isset($_SESSION['user']))
                    {
                     $usersData= getUsersData(getId($_SESSION['user']));
           ...
           <table align="center">
              ...
              <tr>
	           <th>Name</th>
	           <td> &nbsp &nbsp &nbsp &nbsp </td>
	           <td> <font color="#0000FF"><?php echo $usersData['ADM_NAME'];?></font></td>
              </tr>
              
              <tr>
	           <th>Phone Number</th>
	           <td> &nbsp &nbsp &nbsp &nbsp </td>
	           <td> <font color="#0000FF"><?php echo $usersData['ADM_PHONE'];?></font></td>
              </tr>
              
              <tr>
	           <th>Email</th>
	           <td> &nbsp &nbsp &nbsp &nbsp </td>
	           <td> <font color="#0000FF"><?php echo $usersData['ADM_EMAIL'];?></font></td>
              </tr>
